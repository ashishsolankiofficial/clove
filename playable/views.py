...
def add_match(request, t_id):
    ...
    return render(request, 'add_match.html', {'form': fm})
...
def list_match(request, t_id):
    ...
    matches = BilateralMatch.objects.all().values('ext_id', 'name', 'match_start_time', 'active', 'teamA__name', 'teamB__name', 'winner', 'created_by__display_name')
    match_list = {
